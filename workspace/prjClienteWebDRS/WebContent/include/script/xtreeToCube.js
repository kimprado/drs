...
var webFXTreeConfig = {
	...
	usePersistence	: false // valor padrão é true
};
...
function WebFXTreeAbstractNode(sText, sAction, starget) {
	this.childNodes  = [];
	this.target = starget;   // NÃO-PADRÃO: Esta linha foi adicionada com o objetivo de Incluir o atributo TARGET nos links. redirecionando a resposta para outro frame
...
function WebFXTreeItem(sText, sAction, sTarget, eParent, sIcon, sOpenIcon) { // mudada a assinatura da function adicionando sTarget para referenciar a outro frame
	this.base = WebFXTreeAbstractNode;
