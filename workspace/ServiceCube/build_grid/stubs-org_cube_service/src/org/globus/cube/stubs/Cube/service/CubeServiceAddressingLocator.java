/**
 * CubeServiceAddressingLocator.java
 *
...
public class CubeServiceAddressingLocator extends org.globus.cube.stubs.Cube.service.CubeServiceLocator implements org.globus.cube.stubs.Cube.service.CubeServiceAddressing {
    public org.globus.cube.stubs.Cube.CubePortType getCubePortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	org.globus.cube.stubs.Cube.CubePortType _stub = getCubePortTypePort(endpoint);
	if (_stub != null) {
