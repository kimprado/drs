...
public class CubeEntryResponse  implements java.io.Serializable {
    private org.globus.index.stubs.Cube.CubeEntry cubeEntry;

    public CubeEntryResponse() {
    }
    ...
    /**
     * Gets the cubeEntry value for this CubeEntryResponse.
     * 
     * @return cubeEntry
     */
    ...
    /**
     * Sets the cubeEntry value for this CubeEntryResponse.
     * 
     * @param cubeEntry
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CubeEntryResponse)) return false;
        CubeEntryResponse other = (CubeEntryResponse) obj;
        ...
        _equals = true && 
            ((this.cubeEntry==null && other.getCubeEntry()==null) || 
             (this.cubeEntry!=null &&
              this.cubeEntry.equals(other.getCubeEntry())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCubeEntry() != null) {
            _hashCode += getCubeEntry().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CubeEntryResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.globus.org/namespaces/examples/core/Cube", ">cubeEntryResponse"));
