/**
 * CubeIndexServiceAddressingLocator.java
 *
...
public class CubeIndexServiceAddressingLocator extends org.globus.index.stubs.Cube.service.CubeIndexServiceLocator implements org.globus.index.stubs.Cube.service.CubeIndexServiceAddressing {
    public org.globus.index.stubs.Cube.CubeIndexPortType getCubeIndexPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	org.globus.index.stubs.Cube.CubeIndexPortType _stub = getCubeIndexPortTypePort(endpoint);
	if (_stub != null) {
